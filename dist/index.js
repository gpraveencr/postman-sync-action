...
function loadRemotePostmanCollections() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield restClient.get(`/collections?workspace=${postmanWorkspaceId}`);
            for (const remoteCollection of data.collections) {
                remotePostmanCollectionsMap.set(remoteCollection.name, remoteCollection);
            }
            core.info(`${remotePostmanCollectionsMap.size} Collection(s) found for the given API Key in Remote Postman`);
        }
        catch (error) {
...
run();
//# sourceMappingURL=sync_collection.js.map
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(9387);
